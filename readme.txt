...
* [Advanced Version Link](https://wordpress.techgasp.com/social-master/)

**ONLINE DEMO**

* Right of the page, sidebar widget
* Inside the post, with shortcode framework
* [Demo Link](https://wordpress.techgasp.com/social-master)
...
4. [Social Master Documentation](https://wordpress.techgasp.com/social-master-documentation/)
...
= Need More Help =
* [Social Master Documentation](https://wordpress.techgasp.com/social-master-documentation)
...
= 5.1.3 =
* Removing social buttons in Universal Shortcodes from excerpts pages since it loads much faster
...
= 5.1.1 =
* Fixing sanatize fields
* adding nonces to fields
