...
if (isset($_POST['update_system_wide'])){
	check_admin_referer( 'save-settings_social_master_admin_settings_wide_table_options' );
	if(is_multisite()){
		//Facebook
		if (isset($_POST['social_master_system_wide_facebook_display'])){
		update_blog_option($blog_id, 'social_master_system_wide_facebook_display', sanitize_text_field($_POST['social_master_system_wide_facebook_display']));
		}
		else{
		...
		update_blog_option($blog_id, 'social_master_system_wide_facebook_page', sanitize_text_field($_POST['social_master_system_wide_facebook_page']));
		}
		else{
		update_blog_option($blog_id, 'social_master_system_wide_facebook_page', '');
		}
		if (isset($_POST['social_master_system_wide_facebook_lang'])){
		update_blog_option($blog_id, 'social_master_system_wide_facebook_lang', sanitize_text_field($_POST['social_master_system_wide_facebook_lang']));
		}
		else{
		update_blog_option($blog_id, 'social_master_system_wide_facebook_lang', '');
		}
		if (isset($_POST['social_master_system_wide_facebook_id'])){
		update_blog_option($blog_id, 'social_master_system_wide_facebook_id', sanitize_text_field($_POST['social_master_system_wide_facebook_id']));
		}
		else{
		...
		update_blog_option($blog_id, 'social_master_system_wide_facebook_og_name_on', sanitize_text_field($_POST['social_master_system_wide_facebook_og_name_on']));
		}
		else{
		...
		update_blog_option($blog_id, 'social_master_system_wide_facebook_og_type_on', sanitize_text_field($_POST['social_master_system_wide_facebook_og_type_on']));
		}
		else{
		...
		update_blog_option($blog_id, 'social_master_system_wide_facebook_og_title_on', sanitize_text_field($_POST['social_master_system_wide_facebook_og_title_on']));
		}
		else{
		...
		update_blog_option($blog_id, 'social_master_system_wide_facebook_og_url_on', sanitize_text_field($_POST['social_master_system_wide_facebook_og_url_on']));
		}
		else{
		...
		update_blog_option($blog_id, 'social_master_system_wide_facebook_og_description_on', sanitize_text_field($_POST['social_master_system_wide_facebook_og_description_on']));
		}
		else{
		...
		update_blog_option($blog_id, 'social_master_system_wide_facebook_og_image_on', sanitize_text_field($_POST['social_master_system_wide_facebook_og_image_on']));
		}
		else{
		...
		update_blog_option($blog_id, 'social_master_system_wide_facebook_og_image', sanitize_text_field($_POST['social_master_system_wide_facebook_og_image']));
		}
		else{
		...
		update_blog_option($blog_id, 'social_master_system_wide_twitter_user', sanitize_text_field($_POST['social_master_system_wide_twitter_user']));
		}
		else{
		...
		update_blog_option($blog_id, 'social_master_system_wide_twitter_follow_w', sanitize_text_field($_POST['social_master_system_wide_twitter_follow_w']));
		}
		else{
		...
		update_blog_option($blog_id, 'social_master_system_wide_twitter_tweet_w', sanitize_text_field($_POST['social_master_system_wide_twitter_tweet_w']));
		}
		else{
		...
		update_blog_option($blog_id, 'social_master_system_wide_linkedin_page', sanitize_text_field($_POST['social_master_system_wide_linkedin_page']));
		}
		else{
		...
		update_blog_option($blog_id, 'social_master_system_wide_youtube_id', sanitize_text_field($_POST['social_master_system_wide_youtube_id']));
		}
		else{
		...
		update_blog_option($blog_id, 'social_master_system_wide_instagram_user', sanitize_text_field($_POST['social_master_system_wide_instagram_user']));
		}
		else{
		...
		update_blog_option($blog_id, 'social_master_system_wide_soundcloud_page', sanitize_text_field($_POST['social_master_system_wide_soundcloud_page']));
		}
		else{
		...
		update_blog_option($blog_id, 'social_master_system_wide_reverbnation_page', sanitize_text_field($_POST['social_master_system_wide_reverbnation_page']));
		}
		else{
		...
		update_blog_option($blog_id, 'social_master_system_wide_spotify_page', sanitize_text_field($_POST['social_master_system_wide_spotify_page']));
		}
		else{
		...
		update_blog_option($blog_id, 'social_master_system_wide_feedly_page', sanitize_text_field($_POST['social_master_system_wide_feedly_page']));
		}
		else{
		...
		//Facebook
		if (isset($_POST['social_master_system_wide_facebook_display'])){
		update_option('social_master_system_wide_facebook_display', sanitize_text_field($_POST['social_master_system_wide_facebook_display']));
		}
		else{
		update_option('social_master_system_wide_facebook_display', 'false');
		}
		if (isset($_POST['social_master_system_wide_facebook_page'])){
		update_option('social_master_system_wide_facebook_page', sanitize_text_field($_POST['social_master_system_wide_facebook_page']));
		}
		else{
		update_option('social_master_system_wide_facebook_page', '');
		}
		if (isset($_POST['social_master_system_wide_facebook_lang'])){
		update_option('social_master_system_wide_facebook_lang', sanitize_text_field($_POST['social_master_system_wide_facebook_lang']));
		}
		else{
		update_option('social_master_system_wide_facebook_lang', '');
		}
		if (isset($_POST['social_master_system_wide_facebook_id'])){
		update_option('social_master_system_wide_facebook_id', sanitize_text_field($_POST['social_master_system_wide_facebook_id']));
		}
		else{
		update_option('social_master_system_wide_facebook_id', '');
		}
		if (isset($_POST['social_master_system_wide_facebook_og_name_on'])){
		update_option('social_master_system_wide_facebook_og_name_on', sanitize_text_field($_POST['social_master_system_wide_facebook_og_name_on']));
		}
		else{
		update_option('social_master_system_wide_facebook_og_name_on', 'false');
		}
		if (isset($_POST['social_master_system_wide_facebook_og_type_on'])){
		update_option('social_master_system_wide_facebook_og_type_on', sanitize_text_field($_POST['social_master_system_wide_facebook_og_type_on']));
		}
		else{
		update_option('social_master_system_wide_facebook_og_type_on', 'false');
		}
		if (isset($_POST['social_master_system_wide_facebook_og_title_on'])){
		update_option('social_master_system_wide_facebook_og_title_on', sanitize_text_field($_POST['social_master_system_wide_facebook_og_title_on']));
		}
		else{
		update_option('social_master_system_wide_facebook_og_title_on', 'false');
		}
		if (isset($_POST['social_master_system_wide_facebook_og_url_on'])){
		update_option('social_master_system_wide_facebook_og_url_on', sanitize_text_field($_POST['social_master_system_wide_facebook_og_url_on']));
		}
		else{
		update_option('social_master_system_wide_facebook_og_url_on', 'false');
		}
		if (isset($_POST['social_master_system_wide_facebook_og_description_on'])){
		update_option('social_master_system_wide_facebook_og_description_on', sanitize_text_field($_POST['social_master_system_wide_facebook_og_description_on']));
		}
		else{
		update_option('social_master_system_wide_facebook_og_description_on', 'false');
		}
		if (isset($_POST['social_master_system_wide_facebook_og_image_on'])){
		update_option('social_master_system_wide_facebook_og_image_on', sanitize_text_field($_POST['social_master_system_wide_facebook_og_image_on']));
		}
		else{
		update_option('social_master_system_wide_facebook_og_image_on', 'false');
		}
		if (isset($_POST['social_master_system_wide_facebook_og_image'])){
		update_option('social_master_system_wide_facebook_og_image', sanitize_text_field($_POST['social_master_system_wide_facebook_og_image']));
		}
		else{
		...
		//Twitter
		if (isset($_POST['social_master_system_wide_twitter_user'])){
		update_option('social_master_system_wide_twitter_user', sanitize_text_field($_POST['social_master_system_wide_twitter_user']));
		}
		else{
		update_option('social_master_system_wide_twitter_user', '');
		}
		if (isset($_POST['social_master_system_wide_twitter_follow_w'])){
		update_option('social_master_system_wide_twitter_follow_w', sanitize_text_field($_POST['social_master_system_wide_twitter_follow_w']));
		}
		else{
		update_option('social_master_system_wide_twitter_follow_w', 'false');
		}
		if (isset($_POST['social_master_system_wide_twitter_tweet_w'])){
		update_option('social_master_system_wide_twitter_tweet_w', sanitize_text_field($_POST['social_master_system_wide_twitter_tweet_w']));
		}
		else{
		...
		//Linkedin
		if (isset($_POST['social_master_system_wide_linkedin_page'])){
		update_option('social_master_system_wide_linkedin_page', sanitize_text_field($_POST['social_master_system_wide_linkedin_page']));
		}
		else{
		...
		//Youtube
		if (isset($_POST['social_master_system_wide_youtube_id'])){
		update_option('social_master_system_wide_youtube_id', sanitize_text_field($_POST['social_master_system_wide_youtube_id']));
		}
		else{
		...
		//Instagram
		if (isset($_POST['social_master_system_wide_instagram_user'])){
		update_option('social_master_system_wide_instagram_user', sanitize_text_field($_POST['social_master_system_wide_instagram_user']));
		}
		else{
		...
		//Soundcloud
		if (isset($_POST['social_master_system_wide_soundcloud_page'])){
		update_option('social_master_system_wide_soundcloud_page', sanitize_text_field($_POST['social_master_system_wide_soundcloud_page']));
		}
		else{
		...
		//Reverbnation
		if (isset($_POST['social_master_system_wide_reverbnation_page'])){
		update_option('social_master_system_wide_reverbnation_page', sanitize_text_field($_POST['social_master_system_wide_reverbnation_page']));
		}
		else{
		...
		//Spotify
		if (isset($_POST['social_master_system_wide_spotify_page'])){
		update_option('social_master_system_wide_spotify_page', sanitize_text_field($_POST['social_master_system_wide_spotify_page']));
		}
		else{
		...
		//Feedly
		if (isset($_POST['social_master_system_wide_feedly_page'])){
		update_option('social_master_system_wide_feedly_page', sanitize_text_field($_POST['social_master_system_wide_feedly_page']));
		}
		else{
...
if(is_multisite()){
	$social_master_system_wide_facebook_display = esc_html(get_blog_option($blog_id, 'social_master_system_wide_facebook_display'));
	$social_master_system_wide_facebook_page = esc_html(get_blog_option($blog_id, 'social_master_system_wide_facebook_page'));
	$social_master_system_wide_facebook_lang = esc_html(get_blog_option($blog_id, 'social_master_system_wide_facebook_lang'));
	$social_master_system_wide_facebook_id = esc_html(get_blog_option($blog_id, 'social_master_system_wide_facebook_id'));
	$social_master_system_wide_facebook_og_name_on = esc_html(get_blog_option($blog_id, 'social_master_system_wide_facebook_og_name_on'));
	$social_master_system_wide_facebook_og_type_on = esc_html(get_blog_option($blog_id, 'social_master_system_wide_facebook_og_type_on'));
	$social_master_system_wide_facebook_og_title_on = esc_html(get_blog_option($blog_id, 'social_master_system_wide_facebook_og_title_on'));
	$social_master_system_wide_facebook_og_url_on = esc_html(get_blog_option($blog_id, 'social_master_system_wide_facebook_og_url_on'));
	$social_master_system_wide_facebook_og_description_on = esc_html(get_blog_option($blog_id, 'social_master_system_wide_facebook_og_description_on'));
	$social_master_system_wide_facebook_og_image_on = esc_html(get_blog_option($blog_id, 'social_master_system_wide_facebook_og_image_on'));
	$social_master_system_wide_facebook_og_image = esc_html(get_blog_option($blog_id, 'social_master_system_wide_facebook_og_image'));
	$social_master_system_wide_twitter_user = esc_html(get_blog_option($blog_id, 'social_master_system_wide_twitter_user'));
	$social_master_system_wide_twitter_follow_w = esc_html(get_blog_option($blog_id, 'social_master_system_wide_twitter_follow_w'));
	$social_master_system_wide_twitter_tweet_w = esc_html(get_blog_option($blog_id, 'social_master_system_wide_twitter_tweet_w'));
	$social_master_system_wide_linkedin_page = esc_html(get_blog_option($blog_id, 'social_master_system_wide_linkedin_page'));
	$social_master_system_wide_youtube_id = esc_html(get_blog_option($blog_id, 'social_master_system_wide_youtube_id'));
	$social_master_system_wide_instagram_user = esc_html(get_blog_option($blog_id, 'social_master_system_wide_instagram_user'));
	$social_master_system_wide_soundcloud_page = esc_html(get_blog_option($blog_id, 'social_master_system_wide_soundcloud_page'));
	$social_master_system_wide_reverbnation_page = esc_html(get_blog_option($blog_id, 'social_master_system_wide_reverbnation_page'));
	$social_master_system_wide_spotify_page = esc_html(get_blog_option($blog_id, 'social_master_system_wide_spotify_page'));
	$social_master_system_wide_feedly_page = esc_html(get_blog_option($blog_id, 'social_master_system_wide_feedly_page'));
}
else{
	$social_master_system_wide_facebook_display = esc_html(get_option('social_master_system_wide_facebook_display'));
	$social_master_system_wide_facebook_page = esc_html(get_option('social_master_system_wide_facebook_page'));
	$social_master_system_wide_facebook_lang = esc_html(get_option('social_master_system_wide_facebook_lang'));
	$social_master_system_wide_facebook_id = esc_html(get_option('social_master_system_wide_facebook_id'));
	$social_master_system_wide_facebook_og_name_on = esc_html(get_option('social_master_system_wide_facebook_og_name_on'));
	$social_master_system_wide_facebook_og_type_on = esc_html(get_option('social_master_system_wide_facebook_og_type_on'));
	$social_master_system_wide_facebook_og_title_on = esc_html(get_option('social_master_system_wide_facebook_og_title_on'));
	$social_master_system_wide_facebook_og_url_on = esc_html(get_option('social_master_system_wide_facebook_og_url_on'));
	$social_master_system_wide_facebook_og_description_on = esc_html(get_option('social_master_system_wide_facebook_og_description_on'));
	$social_master_system_wide_facebook_og_image_on = esc_html(get_option('social_master_system_wide_facebook_og_image_on'));
	$social_master_system_wide_facebook_og_image = esc_html(get_option('social_master_system_wide_facebook_og_image'));
	$social_master_system_wide_twitter_user = esc_html(get_option('social_master_system_wide_twitter_user'));
	$social_master_system_wide_twitter_follow_w = esc_html(get_option('social_master_system_wide_twitter_follow_w'));
	$social_master_system_wide_twitter_tweet_w = esc_html(get_option('social_master_system_wide_twitter_tweet_w'));
	$social_master_system_wide_linkedin_page = esc_html(get_option('social_master_system_wide_linkedin_page'));
	$social_master_system_wide_youtube_id = esc_html(get_option('social_master_system_wide_youtube_id'));
	$social_master_system_wide_instagram_user = esc_html(get_option('social_master_system_wide_instagram_user'));
	$social_master_system_wide_soundcloud_page = esc_html(get_option('social_master_system_wide_soundcloud_page'));
	$social_master_system_wide_reverbnation_page = esc_html(get_option('social_master_system_wide_reverbnation_page'));
	$social_master_system_wide_spotify_page = esc_html(get_option('social_master_system_wide_spotify_page'));
	$social_master_system_wide_feedly_page = esc_html(get_option('social_master_system_wide_feedly_page'));
}
?>
<form method="post" width='1'>
<fieldset class="options">
<?php $sec_nonce = wp_nonce_field( 'save-settings_social_master_admin_settings_wide_table_options' ); ?>
	...
	<tbody>
		...
		<tr>
			...
			<td style="vertical-align:middle">
				...
				<div class="description"><a href="https://developers.facebook.com/docs/internationalization/#locales" target="_blank">Click to search your language code.</a></div>
			</td>
		</tr>
		<tr>
			<th class="check-column" scope="row"></th>
		...
		<tr>
			...
			<td style="vertical-align:middle">
				...
				<div class="description">https://yoursite.com/feed/</div>
			</td>
		</tr>
	</tbody>
</table>
